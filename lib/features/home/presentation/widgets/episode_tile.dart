...
class EpisodeListTile extends StatefulWidget {
  const EpisodeListTile({super.key, required this.episo, required this.index});
  final PodcastModel episo;
  final int index;

  @override
  State<EpisodeListTile> createState() => _PodcastListTileState();
}

class _PodcastListTileState extends State<EpisodeListTile> {
  @override
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text("${widget.episo.podcastSize!.toStringAsFixed(3)} MB",
                              style: TextStyle(
                                  color: greyColor,
                                  fontWeight: FontWeight.w500,
                                  fontSize: 10.sp)),
